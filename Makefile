SHELL := /bin/bash
#DOCKER_COMPOSE_FILE ?= ./src/infrastructure/docker-compose.yml
DOCKER_COMPOSE_FILE ?= ./src/infrastructure/docker-compose.cluster.yml
...
volume-remove-cluster: volume-remove-mssql01 volume-remove-mssql02 volume-remove-mssql03 volume-remove-certificates
